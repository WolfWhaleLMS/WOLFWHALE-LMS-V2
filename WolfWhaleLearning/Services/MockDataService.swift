...
struct MockDataService {
    ...
    func sampleQuizzes() -> [Quiz] {
        let cal = Calendar.current
        return [
            Quiz(id: UUID(), title: "Chapter 5: Quadratics", courseId: UUID(), courseName: "Algebra II", questions: makeQuizQuestions(), timeLimit: 30, dueDate: cal.date(byAdding: .day, value: 3, to: Date())!, isCompleted: false, score: nil, xpReward: 0),
            Quiz(id: UUID(), title: "Cellular Respiration", courseId: UUID(), courseName: "AP Biology", questions: makeQuizQuestions(), timeLimit: 25, dueDate: cal.date(byAdding: .day, value: 1, to: Date())!, isCompleted: true, score: 88, xpReward: 0),
            Quiz(id: UUID(), title: "Ancient Civilizations", courseId: UUID(), courseName: "World History", questions: makeQuizQuestions(), timeLimit: 20, dueDate: cal.date(byAdding: .day, value: -3, to: Date())!, isCompleted: true, score: 95, xpReward: 0),
        ]
    }
