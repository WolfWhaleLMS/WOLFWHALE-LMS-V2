...
struct AdminSetupView: View {
            ...
            VStack(alignment: .leading, spacing: 8) {
                ...
                VStack(alignment: .leading, spacing: 4) {
                    ...
                    .overlay(
                        RoundedRectangle(cornerRadius: 12)
                            .strokeBorder(
                                passwordValidationError != nil ? Color.red.opacity(0.5)
                ...
                VStack(alignment: .leading, spacing: 4) {
                    ...
                    .overlay(
                        RoundedRectangle(cornerRadius: 12)
                            .strokeBorder(
                                confirmPasswordValidationError != nil ? Color.red.opacity(0.5)
                    ...
                    if let confirmPasswordValidationError {
    ...
    private var isFormValid: Bool {
        ...
        && passwordValidationError == nil && !password.isEmpty
        && confirmPasswordValidationError == nil && !confirmPassword.isEmpty
    }
