    ...
    func loadThreads(courseId: UUID) {
        ...
        Task {
            do {
                ...
                #if DEBUG
                print("[AppViewModel] loadThreads failed: \(error)")
                #endif
            }
        }
    }
        ...
        if !isDemoMode {
            Task {
                do {
                    ...
                    #if DEBUG
                    print("[AppViewModel] createThread failed: \(error)")
                    #endif
                }
            }
        }
        ...
        if !isDemoMode {
            Task {
                do {
                    ...
                    #if DEBUG
                    print("[AppViewModel] replyToThread failed: \(error)")
                    #endif
                }
            }
        }
    ...
    func loadReplies(threadId: UUID) {
        ...
        Task {
            do {
                ...
                #if DEBUG
                print("[AppViewModel] loadReplies failed: \(error)")
                #endif
            }
        }
    }
        ...
        if !isDemoMode {
            Task {
                do {
                    ...
                    #if DEBUG
                    print("[AppViewModel] pinThread failed: \(error)")
                    #endif
                }
            }
        }
